...
import { withCtx, createVNode, createTextVNode, useSSRContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/node_modules/vue/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<h6 class="prices-content__iTextBox__div__h6 text-transform-uppercase f-700"> LAK\xC1STEXTIL VEGYTISZT\xCDT\xC1S </h6><div class="prices-content__iTextBox__div__prices-box pa"><h3 class="prices-content__iTextBox__div__prices-box__h3 text-center text-color-w"> 1400 Ft-t\xF3l </h3></div></div></div><div class="prices-content__lBox text-center">`);
  _push(ssrRenderComponent(_component_NuxtLink, { class: "page-link page-link--format text-color f-600" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Teljes \xE1rlista `);
      } else {
        return [
          createTextVNode(" Teljes \xE1rlista ")
        ];
      }
    }),
    _: 1
  ...
  _push(`<div class="page-information-content__iTextBox page-information-content__iTextBox--format bg-color-w pa"><h4 class="page-information-content__iTextBox__h4 text-transform-uppercase f-700"> H\xC1ZT\xD3L H\xC1ZIG SZ\xC1LL\xCDT\xC1S </h4><p class="page-information-content__iTextBox__p f-500"> C\xE9g\xFCnk b\xFCszk\xE9n k\xEDn\xE1lja vev\u0151inek a folyamatos, 0-24 \xF3r\xE1s online megrendel\xE9si lehet\u0151s\xE9get, ami lehet\u0151v\xE9 teszi, hogy b\xE1rmikor, b\xE1rhol leadhass\xE1k rendel\xE9seiket. Elk\xF6telezettek vagyunk amellett, hogy term\xE9keinket gyorsan \xE9s hat\xE9konyan sz\xE1ll\xEDtsuk h\xE1zt\xF3l h\xE1zig, biztos\xEDtva ezzel, hogy mindenki sz\xE1m\xE1ra k\xE9nyelmes \xE9s z\xF6kken\u0151mentes legyen a v\xE1s\xE1rl\xE1si \xE9lm\xE9ny. </p><p class="page-information-content__iTextBox__p f-500"> A h\xE1zhozsz\xE1ll\xEDt\xE1sunk rugalmas \xE9s megb\xEDzhat\xF3, \xEDgy \xFCgyfeleink mindig id\u0151ben megkapj\xE1k a k\xEDv\xE1nt term\xE9keket, mindezt an\xE9lk\xFCl, hogy otthonuk k\xE9nyelm\xE9t elhagyn\xE1k. </p><div class="page-information-content__iTextBox__link-box"><a href="tel:+36707777615" class="page-link page-link--format text-color f-600"> Leadom a rendel\xE9sem </a></div></div><div class="page-information-content__blog-content"><h3 class="page-information-content__blog-content__h3 text-center text-transform-uppercase f-700"> BLOG </h3><div class="page-information-content__blog-content__gBox pr grid-3"><div class="page-information-content__blog-content__gBox__iTextBox">`);
  _push(ssrRenderComponent(_component_NuxtImg, {
    src: "/img/page-information/blog/blog.jpg",
    alt: "Vasal\xE1s Mester",
    class: "page-information-content__blog-content__gBox__iTextBox__img"
  }, null, _parent));
  _push(`<div class="page-information-content__blog-content__gBox__iTextBox__tBox"><h5 class="page-information-content__blog-content__gBox__iTextBox__tBox__h5 text-color-w"> A Gy\u0171r\u0151d\xE9smentess\xE9g M\u0171v\xE9szete </h5><p class="page-information-content__blog-content__gBox__iTextBox__tBox__p text-color-w"> Fedezd fel a t\xF6k\xE9letesen sima ruhadarabok el\xE9r\xE9s\xE9nek titkait! Bemutatjuk a legjobb vasal\xE1si technik\xE1kat \xE9s eszk\xF6z\xF6ket, amelyek seg\xEDtenek a gy\u0171r\u0151d\xE9sek n\xE9lk\xFCli, kifog\xE1stalan megjelen\xE9s el\xE9r\xE9s\xE9ben, ak\xE1r otthon, ak\xE1r \xFAtk\xF6zben. </p></div></div><div class="page-information-content__blog-content__gBox__iTextBox">`);
  _push(ssrRenderComponent(_component_NuxtImg, {
  ...
  _push(`<div class="page-information-content__blog-content__gBox__iTextBox__tBox"><h5 class="page-information-content__blog-content__gBox__iTextBox__tBox__h5 text-color-w"> A Gy\u0171r\u0151d\xE9smentess\xE9g M\u0171v\xE9szete </h5><p class="page-information-content__blog-content__gBox__iTextBox__tBox__p text-color-w"> Fedezd fel a t\xF6k\xE9letesen sima ruhadarabok el\xE9r\xE9s\xE9nek titkait! Bemutatjuk a legjobb vasal\xE1si technik\xE1kat \xE9s eszk\xF6z\xF6ket, amelyek seg\xEDtenek a gy\u0171r\u0151d\xE9sek n\xE9lk\xFCli, kifog\xE1stalan megjelen\xE9s el\xE9r\xE9s\xE9ben, ak\xE1r otthon, ak\xE1r \xFAtk\xF6zben. </p></div></div></div></div></div></section><!--]-->`);
}
...
//# sourceMappingURL=index-CnRuGEfm.mjs.map
