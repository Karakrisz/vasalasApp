import { c as useRuntimeConfig, b as __nuxt_component_0, a as __nuxt_component_0$1 } from './server.mjs';
import { defineComponent, withAsyncContext, withCtx, createVNode, createTextVNode, unref, toDisplayString, useSSRContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: itemsPost } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "posts",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_NuxtImg, {
                ...
                src: `${unref(config).public.apiBaseUrl}/storage/${post.image}`,
                alt: "{{ post.title }}"
              }, null, _parent2, _scopeId));
              _push2(`<div class="page-information-content__blog-content__gBox__iTextBox__tBox"${_scopeId}><h5 class="page-information-content__blog-content__gBox__iTextBox__tBox__h5 text-color-w"${_scopeId}>${ssrInterpolate(post.title)}</h5><p class="page-information-content__blog-content__gBox__iTextBox__tBox__p text-color-w"${_scopeId}>${(_a = truncateContent(post.body, 150)) != null ? _a : ""}</p></div>`);
            } else {
              return [
                createVNode(_component_NuxtImg, {
                  height: "100%",
                ...
                createVNode("div", { class: "page-information-content__blog-content__gBox__iTextBox__tBox" }, [
                  ...
                  createVNode("p", {
                    ...
                    innerHTML: truncateContent(post.body, 150)
                  }, null, 8, ["innerHTML"])
                ])
              ];
            }
...
//# sourceMappingURL=index-P859iZpe.mjs.map
