...
const _routes = [
  ...
  },
  {
    name: "ajanlatkeres",
    path: "/ajanlatkeres",
    component: () => import('./ajanlatkeres-CS7k_Zgd.mjs')
  },
  {
    name: "arlista",
    path: "/arlista",
    component: () => import('./arlista-CfmNvJyi.mjs')
  },
  {
    name: "egyeni-igenyek",
    path: "/egyeni-igenyek",
  ...
  },
  {
    name: "hidden-blog",
    path: "/hidden-blog",
    component: () => import('./hidden-blog-ipU-7RVZ.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-HCBEK8s5.mjs')
  },
  {
    name: "javitas",
    path: "/javitas",
  ...
  },
  {
    name: "posts-slug",
    path: "/posts/:slug()",
    component: () => import('./_slug_-M9xkrtQt.mjs')
  },
  {
    name: "rolunk",
    path: "/rolunk",
  ...
  },
  {
    name: "szolgaltatasok",
    path: "/szolgaltatasok",
    component: () => import('./szolgaltatasok-CWE_gkdl.mjs')
  },
  {
    name: "tisztitas",
    path: "/tisztitas",
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="footer-content__bottom__infoBox__header__lBox"><p class="footer-content__bottom__infoBox__header__lBox__p"><a class="footer-content__bottom__infoBox__header__lBox__p__link text-color-w" href="tel:+36307777609">`);
      _push(ssrRenderComponent(_component_NuxtImg, {
...
export { _export_sfc as _, __nuxt_component_0 as a, _sfc_main$5 as b, useRuntimeConfig as c, useRoute as d, entry$1 as default, useNuxtApp as e, asyncDataDefaults as f, createError as g, useHead as u };
