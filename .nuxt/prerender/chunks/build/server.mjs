...
import { appendHeader, createError as createError$1, sanitizeStatusCode } from 'file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/node_modules/h3/dist/index.mjs';
import { getActiveHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/node_modules/unhead/dist/index.mjs';
...
import { hasProtocol, joinURL, parseURL, parseQuery, encodeParam, withLeadingSlash, withQuery, isScriptProtocol, withTrailingSlash, withoutTrailingSlash, encodePath } from 'file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderClass, ssrRenderList, ssrInterpolate, ssrRenderAttr } from 'file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/node_modules/vue/server-renderer/index.mjs';
...
const ipxStaticRuntime$u3AOtGUOEU = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="footer-content__bottom__infoBox__header__lBox"><p class="footer-content__bottom__infoBox__header__lBox__p"><a class="footer-content__bottom__infoBox__header__lBox__p__link text-color-w" href="tel:+36707777609">`);
      _push(ssrRenderComponent(_component_NuxtImg, {
