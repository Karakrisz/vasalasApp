...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withBase, withoutTrailingSlash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/node_modules/ufo/dist/index.mjs';
...
import { renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/node_modules/@unhead/ssr/dist/index.mjs';
...
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/node_modules/consola/dist/index.mjs';
...
import { createServerHead as createServerHead$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/vasalasApp/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _ImxLfRrzUb = (function(nitro) {
...
const _EJjmH9 = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _nZRYGK = defineEventHandler(async (e) => {
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/vasalasApp/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
